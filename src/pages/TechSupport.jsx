...
import TechStrategy from '../Components/Tech/TechStrategy'
import TechPricePlan from '../Components/Tech/TechPricePlan'
...
function TechSupport() {
  return (
    <div>
        ...
        <h2 className='text-[150px] font-gallient font-light leading-[7vw] py-[4vw]'>Seamless Support<br /> for Every Step <span className='font-light italic'>Forward.</span></h2>
